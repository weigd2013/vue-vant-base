  ...
  <div id="order">
    ...
    <van-cell-group>
      ...
      <div class="wrapper" @click="goToGoodsList">
        <div ref="productImageWrapper" class="productImageWrapper">
          <ul ref="imageWrapper" class="imageWrapper">
            <li
    ...
    <van-radio-group v-model="radio">
      <van-cell-group title="支付方式">
        <van-cell clickable @click="radio = '1'">
          <template slot="title">
            <img
              src="http://oss.mathgame.cc:8088/mall/assert/order/wx.png"
              alt=""
              width="25px"
              height="25px"
        ...
        <van-cell clickable @click="radio = '2'">
          <template slot="title">
            <img
              src="http://oss.mathgame.cc:8088/mall/assert/order/zfb.png"
              alt=""
              width="25px"
              height="25px"
              style=" vertical-align: middle;padding-right:5px"
        ...
        <van-cell clickable @click="radio = '3'">
          <template slot="title">
            <img
              src="http://oss.mathgame.cc:8088/mall/assert/order/hb.png"
              alt=""
              width="25px"
              height="25px"
              style=" vertical-align: middle;padding-right:5px"
